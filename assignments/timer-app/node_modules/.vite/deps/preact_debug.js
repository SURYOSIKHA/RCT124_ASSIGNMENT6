...
` + f(this.__v)), b2.call(this, n);
  ...
  var t = n.type, o2 = e.map(function(n2) {
    return n2.localName;
  });
  console.error("Expected a DOM node of type " + t + " but found " + o2.join(", ") + "as available DOM-node(s), this is caused by the SSR'd HTML containing different DOM-nodes compared to the hydrated one.\n\n" + f(n));
}, function() {
  !function() {
  ...
  var n = false, t = l.__b, r2 = l.diffed, c2 = l.vnode, l3 = l.__r, v2 = l.__e, b3 = l.__, g = l.__h, E = d ? { useEffect: /* @__PURE__ */ new WeakMap(), useLayoutEffect: /* @__PURE__ */ new WeakMap(), lazyPropTypes: /* @__PURE__ */ new WeakMap() } : null, k2 = [];
  ...
  l.__r = function(e) {
    l3 && l3(e), n = true;
    var t2 = e.__c;
    if (t2 === T ? _++ : _ = 1, _ >= 25) throw new Error("Too many re-renders. This is limited to prevent an infinite loop which may lock up your browser. The component causing this is: " + a(e));
    T = t2;
  ...
  l.vnode = function(n2) {
    ...
    if (e.__k && e.__k.forEach(function(n2) {
    ...
    }), e.__c === T && (_ = 0), "string" == typeof o2 && (y(o2) || "p" === o2 || "a" === o2 || "button" === o2)) {
      var s2 = h(i2);
      ...
      } else "a" !== o2 && "button" !== o2 || -1 !== p(e).indexOf(o2) && console.error("Improper nesting of interactive content. Your <" + o2 + "> should not have other " + ("a" === o2 ? "anchor" : "button") + " tags as child-elements." + w(e) + "\n\n" + f(e));
    }
